        ...
        readonly string[] AllSlots =
{
    ...
    VALUES (?, ?, ?, ?, ?, ?, ?)", conn);
        ...
        private int GetUserInfoID(string loginId)
        {
            ...
            using (OleDbConnection conn = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\Raphael\source\repos\ClinicManagementSystemFinal\ClinicManagementSystemFinal\Login.accdb;Persist Security Info=False;"))
            {
                conn.Open();
